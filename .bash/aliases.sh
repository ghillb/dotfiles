...
alias gcm='_git_commit_with_msg'
alias gcam='_git_commit_with_msg --amend'
alias gd='git diff'
alias gdi='difit --port 47831 --no-open --background . --include-untracked'
...
function gg { local dir="${1:-.}"; nvim -c "cd $dir" -c Neogit; }
alias vv='gg'
alias vvv='nvim .'

...
map("n", "<a-+>", "<c-w>>")
map("n", "<a-_>", "<c-w><")
map("n", "<a-g>", ":Neotree close<cr>:G<cr>")
map("n", "<a-o>", "<c-w>o<cr>")
...
map("n", "<leader>tc", ":lua toggle_variable({var='copilot_enabled', default=false})<cr>", { silent = true })
...
map("n", "<leader>gfl", ":G -c pull.default=current pull -f<cr>")
map("n", "<leader>gfs", ":G -c push.default=current push -f<cr>")
...
map("n", "<localleader>vt", ":lua require('plenary.test_harness').test_directory(vim.fn.expand('%:p'))<cr>")

...
map("n", "<a-c-p>", ":AsyncTask project-stop<cr>")
...
map("n", "<leader>tm", ":Glow<cr><c-w>\\| <c-w>_")
map("n", "<leader>tt", "<cmd>TroubleToggle<cr>")
map("n", "<leader>se", ":VsnipOpen<cr>")
map("v", "<leader>se", ":VsnipYank title <bar> VsnipOpenVsplit")
...
map("n", "<leader>id", "i<c-r>=expand('%:p:h').'/'<cr><esc>")

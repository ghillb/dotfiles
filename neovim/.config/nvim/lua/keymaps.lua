...
map("n", "<a-\\>", user.fn.new_terminal, { silent = true })
map("t", "<a-.>", "<c-\\><c-n>:Tnext<cr>i")
map("t", "<a-,>", "<c-\\><c-n>:Tprevious<cr>i")
map("t", "<a-\\>", user.fn.new_terminal, { silent = true })
map("t", "`", "<esc>")
map("t", "<esc>", "<c-\\><c-n>")
...
map("n", "<a-h>", ":lua user.fn.tmux_switch_pane('h')<cr>", { silent = true })
map("n", "<a-j>", ":lua user.fn.tmux_switch_pane('j')<cr>", { silent = true })
map("n", "<a-k>", ":lua user.fn.tmux_switch_pane('k')<cr>", { silent = true })
map("n", "<a-l>", ":lua user.fn.tmux_switch_pane('l')<cr>", { silent = true })

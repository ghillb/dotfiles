...
map("c", "<tab>", "<nop>")
map("c", "<s-tab>", "<nop>")
map("i", "<tab>", "v:lua.vim.fn.user.tab_binding()", { expr = true })
map("i", "<s-tab>", "v:lua.vim.fn.user.s_tab_binding()", { expr = true })
...
map("n", "gf", vim.fn.user.create_or_go_to_file, { silent = true })
...
map("n", "<a-\\>", vim.fn.user.new_terminal, { silent = true })
map("t", "<a-.>", "<c-\\><c-n>:Tnext<cr>i")
map("t", "<a-,>", "<c-\\><c-n>:Tprevious<cr>i")
map("t", "<a-\\>", vim.fn.user.new_terminal, { silent = true })
map("t", "`", "<esc>")
map("t", "<esc>", "<c-\\><c-n>")
...
map("n", "<a-h>", ":lua vim.fn.user.tmux_switch_pane('h')<cr>", { silent = true })
map("n", "<a-j>", ":lua vim.fn.user.tmux_switch_pane('j')<cr>", { silent = true })
map("n", "<a-k>", ":lua vim.fn.user.tmux_switch_pane('k')<cr>", { silent = true })
map("n", "<a-l>", ":lua vim.fn.user.tmux_switch_pane('l')<cr>", { silent = true })
map("n", "<a-e>", vim.fn.user.drawer_toggle)
map("n", "<a-q>", vim.fn.user.close_view)
map("n", "<a-->", "<c-w>-")
map("n", "<a-=>", "<c-w>+")
map("n", "<a-+>", "<c-w>>")
map("n", "<a-_>", "<c-w><")
map("n", "<a-g>", vim.fn.user.toggle_fugitive)
map("n", "<a-o>", "<c-w>o<cr>")
...
map("n", "<leader>tg", vim.fn.user.toggle_gutter)
...
map("n", "<localleader><cr>", ":lua vim.fn.user.set_root('git_worktree', true)<cr>", { silent = true })
map("n", "<localleader><bs>", ":lua vim.fn.user.set_root('parent_dir', true)<cr>", { silent = true })
map("n", "<localleader>/", ":lua vim.fn.user.set_root('file_dir', true)<cr>", { silent = true })
map("n", "<localleader>\\", ":lua vim.fn.user.set_root('origin', true)<cr>", { silent = true })

-- TODO: remove astronauta and use native vim.keymap api in nvim 0.7
...
nnoremap({ "<a-s-p>", ":AsyncTask project-run<cr>" })
nnoremap({ "<a-c-p>", ":AsyncTask project-stop<cr>" })
...
noremap({ "<c-w>t", ":$tabnew<cr>:sleep 50m<cr>:Telescope find_files<cr>" })
...
nnoremap({ "<a-bs>", "<cmd>TroubleToggle document_diagnostics<cr>" })
